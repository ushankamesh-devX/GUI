...
function Navbar() {
  ...
  return (
    <div className="absolute z-40 w-full top-0 sticky">
      <nav >
        ...
        <section className="navbar-upper flex flex-row justify-between items-center px-8 py-4 bg-myBlack">
          <Link title="BuyNest" className="text-myWhite text-3xl " ><span className="font-semibold text-myYellow">Buy</span>Nest</Link>
          ...
          <div className="auth flex flex-row items-center ">
            ...
            <div className="-space-y-0.5">
              ...
              <button onClick={toggleDropdown} ref={dropdownRef} className="register flex flex-row items-center text-myWhite hover:underline">
                <p>Register/Login</p>
          ...
          {isDropdownOpen && (
            <div className=" flex flex-col items-center justify-center absolute z-50 right-36 top-20 mt-2 px-6 w-64 bg-white text-black shadow-lg rounded-3xl">
              <div>
          ...
          <Link title="Go to Cart" className="cart flex flex-row text-myWhite items-start">
        ...
        <section className="nav-footer flex flex-row justify-between px-8 bg-myBlack border-t-2 py-2">
          <button onClick={toggleCatagory} ref={catagoryRef} className="flex flex-row items-center space-x-2 bg-myBlackLite border border-myBlack border-opacity-25 hover:border-myGray  text-myGray py-1 px-4 rounded-full">
            <p>All Catagories</p>
            <RiListUnordered/>
          </button>
          {isCatagoryOpen && (
            <ul className=" flex flex-col items-center justify-center absolute z-50 left-5 top-36 mt-2 px- w-64 rounded-lg text-black  ">
              
              <ul className="w-full space-y-2 font-bold text-myBlackLite  bg-myWhite rounded-lg">
                <li className=" rounded-lg hover:underline hover:bg-myGray px-4"><Link>Profile</Link></li>
                <li className=" rounded-lg hover:underline hover:bg-myGray px-4"><Link>Profile</Link></li>
                <li className=" rounded-lg hover:underline hover:bg-myGray px-4"><Link>Profile</Link></li>
                <li className=" rounded-lg hover:underline hover:bg-myGray px-4"><Link>Profile</Link></li>
          ...
          <ul className="flex flex-row text-myGray space-x-9 font-normal">
            ...
            <li className="hover:underline"><Link>Support</Link></li>
